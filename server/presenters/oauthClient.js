...
exports.default = presentOAuthClient;
exports.presentDCRClient = presentDCRClient;
exports.presentPublishedOAuthClient = presentPublishedOAuthClient;
/**
 ...
 */
function presentDCRClient(baseUrl, oauthClient, _ref) {
  let {
  ...
  return {
    ...
    ...(includeCredentials && oauthClient.clientType === "confidential" && {
    ...
    response_types: ["code"],
    token_endpoint_auth_method: oauthClient.clientType === "confidential" ? "client_secret_post" : "none",
    ...(oauthClient.developerUrl && {
      client_uri: oauthClient.developerUrl
    }),
    ...(oauthClient.avatarUrl && {
      logo_uri: oauthClient.avatarUrl
    }),
    ...(includeRegistrationAccessToken && {
 ...
 * @param oauthClient The OAuth client to present
 */
function presentOAuthClient(oauthClient) {
  return {
    id: oauthClient.id,
 ...
 * @param oauthClient The OAuth client to present
 */
function presentPublishedOAuthClient(oauthClient) {
  return {
    name: oauthClient.name,
    description: oauthClient.description,
    developerName: oauthClient.developerName,
