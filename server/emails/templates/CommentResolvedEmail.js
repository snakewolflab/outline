...
class CommentResolvedEmail extends _BaseEmail.default {
  ...
  preview(_ref4) {
    ...
    return this.t("{{ actorName }} resolved a comment thread", {
      actorName
    });
  }
  fromName(_ref5) {
  ...
  renderAsText(_ref6) {
    ...
    const action = this.t("{{ actorName }} resolved a comment thread on “{{ documentTitle }}”", {
      actorName,
      documentTitle: document.titleWithDefault
    });
    ...
    return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_EmailLayout.default, {
      ...
      children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_Header.default, {}), /*#__PURE__*/(0, _jsxRuntime.jsxs)(_Body.default, {
        children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_Heading.default, {
          ...
          children: [this.t("{{ actorName }} resolved a comment on", {
            actorName
