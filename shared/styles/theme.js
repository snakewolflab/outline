...
const buildBaseTheme = input => {
  ...
  return {
    ...
    commentMarkBackground: (0, _polished.transparentize)(0.5, colors.brand.marine),
    commentedImageOutlineDark: colors.brand.marine,
    commentedImageOutlineLight: (0, _polished.transparentize)(0.7, colors.brand.marine),
...
const buildDarkTheme = input => {
  ...
  return {
    ...
    sidebarHoverBackground: (0, _polished.lighten)(0.05, colors.veryDarkBlue),
    sidebarActiveBackground: (0, _polished.lighten)(0.09, colors.veryDarkBlue),
    sidebarControlHoverBackground: colors.white10,
    sidebarDraftBorder: (0, _polished.lighten)(0.2, colors.veryDarkBlue),
    ...
    buttonNeutralHoverBackground: (0, _polished.lighten)(0.09, colors.veryDarkBlue),
