...
function isCurrency(value) {
  ...
  const hasCurrencySymbol = currencySymbols.some(symbol => trimmed.includes(symbol));
  ...
  const sortedSymbols = [...currencySymbols].sort((a, b) => b.length - a.length);
...
function parseCurrency(value) {
  ...
  const isNegative = trimmed.startsWith("(") || trimmed.startsWith("-") || trimmed.includes(")-") || trimmed.endsWith(")") && trimmed.includes("(");
