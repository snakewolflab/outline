...
function normalizeUrl(url) {
  const stripped = (0, _compat.trim)(url.replace(/(https?:)?\/\//, ""));
  ...
  const hostWithPort = atIndex !== -1 ? authority.substring(atIndex + 1) : authority;
