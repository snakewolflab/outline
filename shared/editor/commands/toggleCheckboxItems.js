...
exports.toggleCheckboxItems = toggleCheckboxItems;
 ...
 */
function toggleCheckboxItems(type) {
  return (state, dispatch) => {
    ...
    const listItem = (0, _findParentNode.findParentNode)(node => node.type === type)(state.selection);
    if (!listItem) {
      return false;
    }
