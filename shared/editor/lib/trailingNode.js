...
exports.requiresTrailingNode = requiresTrailingNode;
exports.trailingNodeNotAfter = void 0;
exports.withTrailingNode = withTrailingNode;
var _prosemirrorModel = require("prosemirror-model");
/** Node names after which a trailing paragraph is not required. */
const trailingNodeNotAfter = exports.trailingNodeNotAfter = ["paragraph", "heading"];
 ...
 */
function requiresTrailingNode(doc) {
  let notAfter = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : trailingNodeNotAfter;
 ...
 */
function withTrailingNode(doc) {
  let notAfter = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : trailingNodeNotAfter;
  const paragraph = doc.type.schema.nodes.paragraph;
  if (!paragraph || !requiresTrailingNode(doc, notAfter)) {
    return doc;
  }
  return doc.copy(doc.content.append(_prosemirrorModel.Fragment.from(paragraph.create())));
}